...
function SkillSection() {
  return (
    <ActivityContainer title="스킬">
      <ActivityItemContainer title="Python" subtitle="">
        <ul>
          <li>Pandas, Polars, Fastapi, Pyspark, Streamlit</li>
          <li>Pytorch, Tensorflow, Airflow, AutoML</li>
        </ul>
      </ActivityItemContainer>
      <ActivityItemContainer title="Big Data & Distributed Systems" subtitle="">
        <ul>
          <li>Hadoop, Kafka, Spark</li>
          <li>Airflow, Ray</li>
        </ul>
      </ActivityItemContainer>
      <ActivityItemContainer title="C++" subtitle="">
        <ul>
          <li>CMake, OpenMP, OpenCV</li>
        </ul>
      </ActivityItemContainer>
      <ActivityItemContainer title="SQL & DB" subtitle="">
        <ul>
    ...
    <ActivityContainer title="경력">
      ...
      >
        <ul>
          ...
          <a href="https://www.dbpia.co.kr/journal/articleDetail?nodeId=NODE11949327">
            <li>
              [논문/한국통신학회] miniEDA: 데이터 메시를 활용한 통합 데이터 분석
              및 품질 관리 플랫폼 (1저자)
            </li>
          </a>
        </ul>
...
function ExperienceSection() {
  return (
    <ActivityContainer title="경험">
      ...
      />
      <ul>
        <li>Airflow 한국사용자모임 2nd Meetup Airflow 101 발표</li>
        <li>파이콘 한국 2024 Airflow 포스터 부스 운영</li>
      </ul>
      <ActivityItemContainer
      ...
      >
        <ul>
          <li>
            <a href="https://festa.io/events/4635">
              [부산] 리눅스 환경(WSL 포함)에서 C++ 실습하기
            </a>{" "}
            주최
          </li>
          <li>
            <a href="https://festa.io/events/4909">
              C++ Korea 2024 부산 Meet-Up(3월)
            </a>{" "}
            주최
          </li>
        </ul>
      ...
      >
        <ul>
          <li>
            <a href="https://event-us.kr/pyconkr/event/71494">
              파이콘 한국 부산 세미나
            </a>{" "}
            주최
          </li>
          <li>
            <a href="https://2024.pycon.kr/">파이콘한국2023,2024 컨퍼런스</a>{" "}
            주최
          </li>
          <li>A11y Team Lead</li>
          <li>
            <a href="https://news.hada.io/topic?id=18584&utm_source=discord&utm_medium=bot&utm_campaign=1983">
              pypi Korean translations 담당자
            </a>
          </li>
        </ul>
      </ActivityItemContainer>
      ...
      >
        <ul>
          ...
          <li>SUSC 2023 Summer: AI논문리딩 스터디 진행</li>
          <li>SUSC 2023 Winter: AI논문리딩 스터디, AutoML 스터디 진행</li>
          <li>SUSC 2024 Summer: AI논문리딩 스터디 진행</li>
          <li>
            SUSC 2024 Winter: AI논문리딩 스터디, Pythonic Python 스터디 진행
          </li>
        </ul>
      </ActivityItemContainer>
      <ActivityItemContainer
      ...
      >
        <ul>
          <li>
            hub-kr 최다기여자{" "}
            <a href="https://github.com/PyTorchKorea/hub-kr">(link)</a>
          </li>
          <li>
            Pytorch-Hub Build Docker 제작{" "}
            <a href="https://github.com/cpprhtn/pytorch-hub-docker">(link)</a>
          </li>
          <li>
            <strong>hub</strong>
            <ul>
              <li>
                ...
                <a href="https://github.com/pytorch/hub/pull/302">link</a>)
              </li>
              <li>
                Fix: lost reference number (
                <a href="https://github.com/pytorch/hub/pull/303">link</a>)
              </li>
              <li>
                fix: space-typo error (
                <a href="https://github.com/pytorch/hub/pull/305">link</a>)
              </li>
              <li>
                fix: typo error (
                <a href="https://github.com/pytorch/hub/pull/306">link</a>)
              </li>
              <li>
                Explicit conversion (
                <a href="https://github.com/pytorch/hub/pull/309">link</a>)
              </li>
            </ul>
          </li>
        </ul>
  ...
  return (
    <ActivityContainer title="학력">
      ...
      >
        <ul>
          <li>
            [논문/한국멀티미디어학회] Anti-UAV 시스템을 위한 UAV 신호 분류 CNN
            모델 (1저자)
            <ul>
          ...
          <li>
            [정책연구] Development of O2O service model for the management of
            chronic diseases for adults
            <ul>
      ...
      >
        <ul>
          <li>
            통계기법을 이용한 해수면온도 관측자료의 이상치 검출 프로그램
            <ul>
              <li>
                <a
                  href="https://www.cros.or.kr/psnsys/cmmn/infoPage.do?w2xPath=/ui/twc/sch/swRscOtct/swRscOtctList.xml"
                  target="_blank"
                >
              ...
              <li>
                4TB 크기의 <code>.nc</code> 확장자 파일 전처리
              </li>
            </ul>
          </li>
        </ul>
